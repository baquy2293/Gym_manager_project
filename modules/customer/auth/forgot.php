...
<div id="loginbox">
        ...
        <div class="control-group">
            <div class="controls">
                <div class="main_input_box">
                    ...
                    <input type="password" name="passwork" placeholder="Mật khẩu..." required/>
                </div>
            </div>
        </div>
        <div class="control-group">
            <div class="controls">
                <div class="main_input_box">
                    ...
                    <input type="password" name="cnfirmpasswork" placeholder="Xác nhận mật khẩu..." required/>
                </div>
            </div>
        </div>
        <div class="form-actions center">
            <button type="submit" class="btn btn-block btn-large btn-info" title="Log In" name="login"
                    value="Admin Login">Đổi mật khẩu
            </button>
        </div>
    </form>
    <?php
    ...
    <div class="pull-right">
        <a href="?module=admin&action=auth/login">Quản trị đăng nhập</a>
    </div>
