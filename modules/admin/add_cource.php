...
if (isPost()) {
    ...
    if (empty(trim($body['plan']))) {
        $errors['time']['required'] = 'Lịch trình bắt buộc phải nhập';
    }
    ...
    if (empty($_FILES['img']['name'])) {
        $errors['img']['required']= 'Hãy chọn ảnh';
    }
    ...
    if (empty($errors)) {
        ...
        if ($insertStatus) {
            ...
            move_uploaded_file($_FILES['img']['tmp_name'],'D:/laragon/btl/Gym_manager_project/templates/img/'.time().$_FILES['img']['name']);
                ...
                <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            <div class="col-md-12 mb-3">
                                <div data-mdb-input-init class="form-outline">
                                    <input type="text" name="name" placeholder="Tên khóa học ..."
                                        class="form-control form-control-lg" value="<?php echo old('name', $old); ?>" />
                            ...
                            <div class="col-md-12 mb-3">
                                <div data-mdb-input-init class="form-outline">
                                    <input type="number" placeholder="Thời hạn...tháng" name="time"
                                        class="form-control form-control-lg" value="<?php echo old('time', $old); ?>" />
                                    <?php echo form_error('time', $errors, '<span class="error btn-warning">', '</span>'); ?>
                                </div>
                            </div>
                            <div class="col-md-12 mb-3">
                                <div data-mdb-input-init class="form-outline">
                                    <input type="text" placeholder="Lịch trình..." name="plan"
                                        class="form-control form-control-lg" value="<?php echo old('plan', $old); ?>" />
                                    <?php echo form_error('time', $errors, '<span class="error btn-warning">', '</span>'); ?>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <div data-mdb-input-init class="form-outline">
                                    <textarea placeholder="Mô tả ..." name="description"
                                        class="form-control form-control-lg"><?php echo old('description', $old); ?></textarea>
                            ...
                            <div class="col-md-12 mb-3">
                                <div data-mdb-input-init class="form-outline">
                                    <label for="img">Ảnh khóa tập</label>
                                    <input type="file" name="img" id="img" accept="image/*" class="form-control">
                                    <?php echo form_error('img', $errors, '<span class="error btn-warning">', '</span>'); ?>
